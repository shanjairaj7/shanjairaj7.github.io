...
export default function RegisterPage() {
  ...
  const submit = event => {
    ...
    trackMeta('CompleteRegistration', { content_name: 'Made for More Live Claude & AI Workshop', currency: 'INR', value: price });
    flush();

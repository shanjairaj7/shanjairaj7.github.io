...
export default function RegisterPage() {
  ...
  return <main className="register-page">
    ...
    <div className="rp-layout">
      ...
      <aside className="rp-summary"><p>YOUR LIVE WORKSHOP INVITATION</p><h2>Sunday, 9 August</h2><div className="rp-invite"><span><b>WHEN</b>3:00 PM–6:00 PM IST</span><span><b>WHERE</b>Live online workshop</span><span><b>WITH</b>Shanjai Raj</span><span><b>YOU WILL GET</b>Live workshop + 2 practical AI sessions + certificate</span></div><div className="rp-value"><p>WHAT YOU WILL LEARN LIVE</p><span><Check/> Prompt AI to get the result you want</span><span><Check/> Use Claude, Gemini, Perplexity and Codex for real work</span><span><Check/> Turn one useful idea into a simple app</span><span><Check/> See how an app can take payments and be shared online</span><span><Check/> BeAhead workshop certificate</span></div><div className="rp-price"><span>{active ? <>Standard live-seat price <s>₹200</s></> : 'Standard live-seat price'}</span><b>{priceLabel}</b><strong>₹{price}</strong>{active && <em>You save ₹50 today</em>}</div><p className="rp-fineprint"><Mail size={14}/> Workshop joining details will be sent after payment is connected and completed.</p></aside>
    </div>
  </main>;
}

...
export default function MadeForMoreAiWorkshop() {
  ...
  return <div className="beahead-page">
    ...
    <main>
      ...
      <section data-track-section="offer" id="beahead-enrol" className="ba-section ba-offer"><div className="ba-offer-card"><div><p className="ba-kicker">YOUR LIVE WORKSHOP INVITATION</p><h2>This Sunday, give yourself a stronger way to work from next week.</h2><p>Join Shanjai live. Learn the tools. Follow the steps. Start using AI in your work from Monday.</p><div className="ba-invitation-details"><span><b>DATE</b>Sunday, 9 August 2026</span><span><b>TIME</b>3:00 PM–6:00 PM IST</span><span><b>FORMAT</b>Live online · Simple English</span></div><div className="ba-includes"><span><Check/> 3-hour live Claude & AI workshop</span><span><Check/> Learn prompting that gets useful results</span><span><Check/> Make Excel, PPT, Word and research work faster</span><span><Check/> Made for More workshop certificate</span></div></div><aside><small>Early-bird workshop seat · ₹150</small><span>One live session. Practical work you can use from Monday.</span><CTA>Reserve my live seat</CTA><p>Secure payment and joining details are the next step.</p></aside></div></section>

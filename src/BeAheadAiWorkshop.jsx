...
export default function MadeForMoreAiWorkshop() {
  ...
  return <div className="beahead-page">
    <div className="ba-alert"><Sparkles size={14}/> LIVE THIS SUNDAY · 9 AUGUST · 3:00 PM–6:00 PM IST <EarlyBirdTimer compact/> <a href="/#/register" onClick={() => track('cta_clicked', { cta: 'top_register_now' })}>Register now</a></div>
    <main>

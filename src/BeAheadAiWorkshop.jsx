...
const faqs = [
  ...
  ['Will the session be live?', 'Yes. This is a live online workshop with Shanjai Raj on Sunday, 16 August, from 3:00 PM to 6:00 PM IST.'],
...
export default function MadeForMoreAiWorkshop() {
  ...
  return <div className="beahead-page">
    <div className="ba-alert"><Sparkles size={14}/> NEXT LIVE SESSION · SUNDAY, 16 AUGUST · 3:00 PM–6:00 PM IST <EarlyBirdTimer compact/> <a href="/#/register" onClick={() => track('cta_clicked', { cta: 'top_register_now' })}>Reserve my seat</a></div>
    <main>
      <section data-track-section="hero" className="ba-hero" id="top">
        ...
        <div className="ba-hero-grid">
          <div>
            ...
            <div className="ba-hero-actions"><CTA>Reserve my live seat · ₹150</CTA><div className="ba-price"><small>Early-bird live seat</small><strong>₹150</strong></div></div>
            <p className="ba-next-session">Next live session · <b>Sunday, 16 August</b> · 3:00 PM–6:00 PM IST<br/>Live online · Simple English · No technical background</p>
          ...
          <div className="ba-hero-media"><MediaSlot src="/images/shanjai-raj-workshop.jpg" label="Shanjai Raj, Made for More workshop instructor"/><div className="ba-float ba-float-one"><Wand2/><b>From manual work</b><span>to AI-assisted work</span></div><div className="ba-float ba-float-two"><Zap/><b>One live session</b><span>practical workflows</span></div><div className="ba-presenter-proof"><b>Shanjai Raj</b><span>AI product builder · Your live mentor</span><div><a href="https://www.linkedin.com/in/shanjai-raj/" target="_blank" rel="noreferrer">LinkedIn ↗</a><a href="https://www.youtube.com/@ShanjaiRaj/videos" target="_blank" rel="noreferrer">YouTube ↗</a></div></div></div>
        </div>
        <div className="ba-session"><div><Clock3/><span><b>Sunday, 16 August</b>3:00 PM–6:00 PM IST</span></div><div><MessageCircle/><span><b>Live online</b>simple English, step by step</span></div><div><Layers3/><span><b>3 hours</b>guided practical workshop</span></div><CTA>Reserve my seat · ₹150</CTA></div>
      </section>

      <section data-track-section="pain" className="ba-section ba-pain">
      ...
      <section data-track-section="outcomes" className="ba-section ba-dark">
      ...
      <section data-track-section="workplace-change" className="ba-section ba-workplace-shift" style={{ background: '#f7f6f2', color: '#151819' }}>
        ...
        <div className="ba-shift-close"><b>You do not need to panic.</b><span>Learn AI before it becomes a basic expectation in your job.</span><CTA>Start with the next live batch</CTA></div>
      </section>

      <section data-track-section="roadmap" className="ba-section ba-curriculum" style={{ background: '#f7f6f2', color: '#151819' }}><p className="ba-kicker">YOUR LIVE WORKSHOP ROADMAP</p><h2>Three hours to change how you work <em>every day.</em></h2><p className="ba-curriculum-intro" style={{ color: '#4b4944' }}>No long theory. No hard words. Watch it live. Follow the steps. Use it in your own work.</p><div className="ba-tool-row">{toolLogos.map(([name, logo]) => <span key={name} style={{ padding: '13px 16px', fontSize: 13 }}><img src={logo} alt={`${name} logo`} loading="lazy" style={{ width: 42, height: 42 }}/>{name}</span>)}</div><div className="ba-modules">{modules.map(([num, title, text]) => <article key={num}><b>{num}</b><div><h3>{title}</h3><p style={{ color: '#4b4944' }}>{text}</p></div><ArrowRight/></article>)}</div><div className="ba-ai-worker-callout"><b>YES — YOU WILL BUILD YOUR OWN AI WORKER LIVE</b><p>It is not just ChatGPT giving one answer. You will build a worker you can message on Telegram, give repeat work to, and let it work for you in the background.</p></div><CTA>Show me the live roadmap</CTA></section>

      <section data-track-section="ai-worker" className="ba-section ba-contrast"><p className="ba-kicker">GO BEYOND ONE PROMPT AT A TIME</p><h2>Do not only ask AI questions.<br/><em>Make AI work for you.</em></h2><div className="ba-compare"><article><h3>Most people stay here</h3><p>Open ChatGPT only when they are stuck.</p><p>Ask one question. Get one answer.</p><p>Do all repeat work by themselves.</p><p>Know AI is important but have no real system.</p></article><article><h3>What you will learn</h3><p>Use simple AI workflows for daily work.</p><p>Make content and ideas faster.</p><p>Build your own AI worker, step by step.</p><p>Message it on Telegram and give it repeat work to do in the background.</p></article></div><div className="ba-contrast-cta"><b>Do not wait until your team is already ahead.</b><CTA>Join the next live batch</CTA></div></section>

      <section className="ba-section ba-work ba-app-idea" style={{ color: '#151819' }}><div className="ba-section-head"><div><p className="ba-kicker">YOUR JOB IS NOT YOUR ONLY OPTION</p><h2>One useful idea can become your <em>first small business.</em></h2></div><div className="ba-note">No technical background.<br/><b>Just an idea people may find useful.</b></div></div><div className="ba-compare"><article><h3>Before AI</h3><p>“I have an idea, but I cannot build it.”</p><p>“A developer or agency will cost too much.”</p><p>“I do not understand apps, databases or online payments.”</p></article><article><h3>What you will see live</h3><p>Explain your idea clearly to AI.</p><p>Make a simple first app people can open.</p><p>Keep customer details in one place.</p><p>Put it online and add a way for customers to pay.</p></article></div><div className="ba-ai-worker-callout"><b>AI CAN HELP YOU START SMALL</b><p>Build a prototype, test an idea, create a side project, or learn the first steps of an app business. You do not need to become a developer first.</p></div><CTA>Show me how to start</CTA></section>

      <section data-track-section="instructor" className="ba-section ba-instructor"><div className="ba-instructor-grid"><MediaSlot src="/images/shanjai-raj-workshop.jpg" className="ba-portrait" label="Shanjai Raj, Made for More workshop instructor"/><div><p className="ba-kicker">A SMALL NOTE FROM SHANJAI</p><h2>I made this workshop because I do not want you to be <em>left behind.</em></h2><div className="ba-letter"><p>Hi, I am Shanjai.</p><p>Every week, companies are changing how people work. AI is doing more work. Teams are becoming smaller. People who know AI are getting more chances.</p><p>This can feel scary. But you do not need to be scared. You need to start.</p><p>I have built products that made seven-figure revenue. One product was later bought by a private equity company. I have also helped large companies use AI to save time and money.</p><p>I have spent more than 1,000 hours using and testing these AI tools. I have selected the best tools and simple steps to help you work faster, do better work, and become very hard to ignore in your job and industry.</p><p>In this live workshop, I will show you these tools and steps. You will learn how to make your daily work faster, make better PPT and Excel work, and build your own AI worker that can do repeat work for you in the background.</p><p>You do not need coding. You do not need to know AI already. Just come live, follow the steps, and start using it in your work.</p><p>If AI is changing work, I want you to be on the winning side of that change.</p><p>See you live,</p><div className="ba-signature">Shanjai Raj</div><small>AI Product Builder · Your workshop mentor</small></div><div className="ba-credentials"><span><ShieldCheck/> Built real products</span><span><ShieldCheck/> Helped companies use AI</span><span><ShieldCheck/> Teaching live, step by step</span></div></div></div></section>

      <section data-track-section="skills" className="ba-section ba-bonuses"><p className="ba-kicker">MORE THAN JUST CHATGPT TIPS</p><h2>Learn the AI skills that help you do your <em>daily work faster.</em></h2><p className="ba-curriculum-intro">You will learn what to ask, which tool to use, and how to turn the answer into work you can send with confidence.</p><div className="ba-bonus-grid"><article><span>LIVE SKILL 01</span><Wand2/><h3>Prompt AI like a professional</h3><p>Give Claude, Gemini, Perplexity or Codex clear instructions. Get useful reports, research, ideas and work — instead of weak answers.</p></article><article><span>LIVE SKILL 02</span><Code2/><h3>Make Excel work easier</h3><p>Use AI to understand formulas, clean data, find insights and make simple summaries without getting stuck.</p></article><article><span>LIVE SKILL 03</span><Zap/><h3>Make better PPT, Word and research</h3><p>Turn rough points into a clear presentation, improve documents, and research faster with the right AI tools.</p></article></div><div className="ba-ai-worker-callout"><b>THIS IS A CHANCE TO PRACTISE — NOT ONLY WATCH</b><p>Bring one small task from your work: an Excel sheet, report, PPT, document or research problem. Follow Shanjai live and use AI on real work from Monday.</p></div></section>

      <section data-track-section="offer" id="beahead-enrol" className="ba-section ba-offer"><div className="ba-offer-card"><div><p className="ba-kicker">YOUR LIVE WORKSHOP INVITATION</p><h2>Give yourself a stronger way to work from next week.</h2><p>Join Shanjai live. Learn the tools. Follow the steps. Start using AI in your work from Monday.</p><div className="ba-invitation-details"><span><b>DATE</b>Sunday, 16 August 2026</span><span><b>TIME</b>3:00 PM–6:00 PM IST</span><span><b>FORMAT</b>Live online · Simple English</span></div><div className="ba-includes"><span><Check/> 3-hour live Claude & AI workshop</span><span><Check/> Learn prompting that gets useful results</span><span><Check/> Make Excel, PPT, Word and research work faster</span><span><Check/> Made for More workshop certificate</span></div></div><aside className="ba-rsvp-card"><div className="ba-rsvp-top"><span>MADE FOR MORE</span><b>YOU’RE INVITED</b></div><div className="ba-rsvp-main"><small>LIVE CLAUDE & AI WORKSHOP</small><h3>Sunday<br/><em>work upgrade</em></h3><p>For working professionals who want to finish more work in less time.</p></div><div className="ba-rsvp-details"><span><b>WHEN</b>16 August · 3:00–6:00 PM IST</span><span><b>WHERE</b>Live online · Simple English</span><span><b>BRING</b>A laptop, if possible</span></div><div className="ba-rsvp-footer"><small>EARLY-BIRD LIVE SEAT · ₹150</small><CTA>Reserve my live seat</CTA><p>Payment and joining details are the next step.</p></div></aside></div></section>

      <section data-track-section="faq" className="ba-section ba-faq"><p className="ba-kicker">FREQUENTLY ASKED QUESTIONS</p><h2>Questions are normal.<br/><em>Starting is your choice.</em></h2><div>{faqs.map(([q, a], i) => <article className={open === i ? 'is-open' : ''} key={q}><button onClick={() => setOpen(open === i ? -1 : i)}><span>{q}</span><ChevronDown/></button>{open === i && <p>{a}</p>}</article>)}</div><div className="ba-final-call"><p><b>You do not need to change your whole career next Sunday.</b><br/>You only need to take your first step.</p><CTA>Reserve my ₹150 seat</CTA></div></section>
    </main>
    ...
    <div className="ba-mobile-cta"><span><b>₹150</b><small>Live · 16 Aug</small></span><CTA>Reserve my live seat</CTA></div>
  </div>;
}
